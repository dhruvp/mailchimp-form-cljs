...
weasel.repl.process_message = (function (){var method_table__13066__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"weasel.repl","process-message"),new cljs.core.Keyword(null,"op","op",-1882987955),new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__13070__auto__,method_table__13066__auto__,prefer_table__13067__auto__,method_cache__13068__auto__,cached_hierarchy__13069__auto__));
})();
...
while (G__25725__i < G__25725__a.length) {G__25725__a[G__25725__i] = arguments[G__25725__i + 0]; ++G__25725__i;}
  args = new cljs.core.IndexedSeq(G__25725__a,0);
} 
return repl_print__delegate.call(this,args);};
repl_print.cljs$lang$maxFixedArity = 0;
repl_print.cljs$lang$applyTo = (function (arglist__25726){
var args = cljs.core.seq(arglist__25726);
...
console_print.cljs$lang$applyTo = (function (arglist__25728){
...
while (G__25730__i < G__25730__a.length) {G__25730__a[G__25730__i] = arguments[G__25730__i + 0]; ++G__25730__i;}
  args = new cljs.core.IndexedSeq(G__25730__a,0);
} 
...
var connect__delegate = function (repl_server_url,p__25732){
var map__25735 = p__25732;
var map__25735__$1 = ((cljs.core.seq_QMARK_.call(null,map__25735))?cljs.core.apply.call(null,cljs.core.hash_map,map__25735):map__25735);
var print = cljs.core.get.call(null,map__25735__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var on_close = cljs.core.get.call(null,map__25735__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.call(null,map__25735__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_open = cljs.core.get.call(null,map__25735__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var verbose = cljs.core.get.call(null,map__25735__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
});})(repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
var map__25736 = cljs.reader.read_string.call(null,evt.message);
var map__25736__$1 = ((cljs.core.seq_QMARK_.call(null,map__25736))?cljs.core.apply.call(null,cljs.core.hash_map,map__25736):map__25736);
var message = map__25736__$1;
var op = cljs.core.get.call(null,map__25736__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.filter.call(null,((function (gntp,repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose){
return (function (name){
return (goog.dependencies_.visited[(gntp[name])]);
});})(gntp,repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose))
,cljs.core.js_keys.call(null,gntp)));
})();

goog.isProvided_ = ((function (repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose){
return (function (_){
return false;
});})(repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose))
;

goog.require = ((function (repl_connection,map__25735,map__25735__$1,print,on_close,on_error,on_open,verbose){
...
var G__25737__i = 0, G__25737__a = new Array(arguments.length -  1);
while (G__25737__i < G__25737__a.length) {G__25737__a[G__25737__i] = arguments[G__25737__i + 1]; ++G__25737__i;}
  p__25732 = new cljs.core.IndexedSeq(G__25737__a,0);
} 
return connect__delegate.call(this,repl_server_url,p__25732);};
connect.cljs$lang$maxFixedArity = 1;
connect.cljs$lang$applyTo = (function (arglist__25738){
var repl_server_url = cljs.core.first(arglist__25738);
var p__25732 = cljs.core.rest(arglist__25738);
return connect__delegate(repl_server_url,p__25732);
});
